...
function useEmotionCache(options) {
  const cache = (0, import_react.useMemo)(() => {
    const cache2 = (0, import_cache.default)({ key: "css", prepend: true, ...options });
    cache2.compat = true;
    return cache2;
  }, [options]);
...
var Link = (0, import_react3.forwardRef)(
  function Link2(props, ref) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_react3.chakra.a, { ref, href, ...rest, as: import_link.default, children });
  }
);
